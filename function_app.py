...
def TrafficDetectionBlobTrigger(myblob: func.InputStream, name: str):
    try:
        ...
        # Upload CSV to Blob
        blob_conn_str = os.environ["CUSTOM_BLOB_STORAGE"]
        blob_service_client = BlobServiceClient.from_connection_string(blob_conn_str)
        result_container = "csv-results-output"
        ...
        logging.info(f"✅ CSV uploaded to blob container success '{result_container}' as {name}_vehicle_data.csv")
